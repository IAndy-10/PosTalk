...
function TimbrePanel({ p, set }) {
  return (
    <div className="panel scroll">
      ...
      {/* Cutoff & Resonance are controlled via the XY pad only (per review). */}
      <div className="group-label">Cutoff × Resonance</div>
      <XYPad
        x={p.timbreCutoff}
      ...
      <div className="group-label">Pre-Drive</div>
      <div className="knob-row">
