...
public:
    ...
    void setCutoff(float hz)     { smoothCutoff.setTargetValue(hz); }
    void setResonance(float q)   { smoothResonance.setTargetValue(q); }
    void setDrivePreDb(float dB) { smoothDrivePre.setTargetValue(juce::Decibels::decibelsToGain(dB)); }
